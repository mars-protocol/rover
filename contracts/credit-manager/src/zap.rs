...
pub fn provide_liquidity(
    ...
    assert_coin_is_whitelisted(deps.storage, &deps.querier, lp_token_out)?;
    assert_coins_are_whitelisted(deps.storage, &deps.querier, coins_in.to_denoms())?;
...
pub fn withdraw_liquidity(
    ...
    assert_coin_is_whitelisted(deps.storage, &deps.querier, &lp_token_action.denom)?;
    ...
    assert_coins_are_whitelisted(deps.storage, &deps.querier, coins_out.to_denoms())?;
