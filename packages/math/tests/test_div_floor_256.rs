...
fn div_floor_raises_with_zero() {
    ...
    assert_eq!(
        Uint128::new(123456).checked_div_floor_256(fraction),
...
fn div_floor_does_nothing_with_one() {
    ...
    let res = Uint128::new(123456)
        .checked_div_floor_256(fraction)
        .unwrap();
...
fn div_floor_does_not_round_on_even_divide() {
    ...
    let res = Uint128::new(25).checked_div_floor_256(fraction).unwrap();
...
fn div_floor_works_when_operation_temporarily_takes_above_max() {
    ...
    let res = Uint128::MAX.checked_div_floor_256(fraction).unwrap(); // 129_631_377_874_643_224_176_523_659_974_006_937_697.1428
    assert_eq!(
...
fn div_floor_works_with_decimal() {
    ...
    let res = Uint128::new(123456).checked_div_floor_256(decimal).unwrap(); // 47030.857
    assert_eq!(Uint128::new(47030), res)
}

#[test]
fn div_floor_works_with_decimal_256() {
    let decimal = Decimal256::from_ratio(21u128, 8u128);
    let res = Uint128::new(123456).checked_div_floor_256(decimal).unwrap(); // 47030.857
    assert_eq!(Uint128::new(47030), res)
}
...
fn checked_div_floor_does_not_panic_on_overflow() {
    ...
    assert_eq!(
        Uint128::MAX.checked_div_floor_256(fraction),
